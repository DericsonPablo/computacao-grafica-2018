...
//The canvas to be drawn upon.
  ...
  public MovingSpotLight()
  {
    ...
    ob.setSchedulingBounds(new BoundingSphere(new Point3d(0.8,0.0,0.7),Double.MAX_VALUE));
...
//*** The cube and its transformation group ***
    ...
    Background bg = new Background(new Color3f(1.0f,0.0f,1.0f));
