...
//*** Generate a cube. ***
    ...
    Color3f ambientColourBox = new Color3f(0.0f,0.0f,0.0f);
    Color3f emissiveColourBox = new Color3f(0.0f,0.0f,0.0f);
    Color3f diffuseColourBox = new Color3f(0.0f,0.0f,0.0f);
    ...
    Box myBox = new Box(0.4f,0.4f,0.4f,boxApp);
...
//***Generate a sphere ***
  ...
  public void addLight(SimpleUniverse su)
  {
    ...
    Vector3f lightDir1  = new Vector3f(0.0f, 7.0f, -1.0f);
    ...
    Color3f lightColour4 = new Color3f(0.0f, 0.2f, 0.2f);
