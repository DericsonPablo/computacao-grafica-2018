...
public class MovingLight extends JFrame {
  ...
  public MovingLight()
  {
    ...
    ob.setSchedulingBounds(new BoundingSphere(new Point3d(1.0,1.0,0.6),Double.MAX_VALUE));
...
//*** The cube and its transformation group ***
    ...
    tfBox2.setTranslation(new Vector3f(-0.95f+r+shift,0.5f,0.0f));
  ...
  public void addLight(SimpleUniverse su)
  {
    ...
    BoundingSphere bounds = new BoundingSphere(new Point3d(1.0,0.0,0.0), Double.MAX_VALUE);
